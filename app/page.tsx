...
function HeroFloatingCard({
  ...
  return (
    <div
      className={`absolute ${widthClass} ${card.variant === "shopify" ? "rounded-md overflow-hidden" : ""} bg-white transition-transform duration-500 shadow-[inset_0_1px_0_rgba(255,255,255,0.7),inset_0_-1px_0_rgba(0,0,0,0.12),0_1px_0_rgba(0,0,0,0.12),0_10px_24px_rgba(0,0,0,0.18)]`}
      style={{
        ...position,
        transform: hovered
    ...
    <div className="theme contents">
      ...
      >
        <div className="grid md:grid-cols-2 gap-0 items-stretch w-full">
          ...
          <aside
            className="relative min-w-0 p-6 flex items-end justify-end divider-indent-left bg-cover bg-center overflow-hidden section-border-b"
